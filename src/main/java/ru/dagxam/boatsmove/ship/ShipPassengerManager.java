...
public final class ShipPassengerManager implements Listener {
    ...
    public void dismount(ShipModel ship) {
        ...
        exit.setYaw(player.getYaw()); exit.setPitch(player.getPitch()); player.teleport(exit);
    }
    ...
    public boolean tick(ShipModel ship) {
        ...
        if (input.isLeft()) ship.yaw(ship.yaw() - turnSpeed);
        if (input.isRight()) ship.yaw(ship.yaw() + turnSpeed);
    ...
    public void onVehicleExit(VehicleExitEvent event) {
        ...
        passengers.remove(shipId); seats.remove(shipId); anchors.remove(shipId);
